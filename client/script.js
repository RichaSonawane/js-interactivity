...
// CODE HERE
function helloButton(eve) {
  sayHelloButton.style.backgroundColor = "black";
  sayHelloButton.style.color = "white";
}
sayHelloButton.addEventListener("mouseover", helloButton);
// PROBLEM 3
/*
...
// CODE HERE
function backToOrg(eve) {
  sayHelloButton.style.backgroundColor = "#EFEFEF";
  sayHelloButton.style.color = "black";
}

sayHelloButton.addEventListener("mouseout", backToOrg);
...
/*
    ...
    Outside of your new function, select the button with the id "query-button" and 
    add a click event listener that calls your function.
*/
...
document.getElementById("query-button").addEventListener("click", queryFun);
////////////////
//INTERMEDIATE//
////////////////
...
// CODE HERE
function createFood(eve) {
  eve.preventDefault();
  let foodInput = document.querySelector("#foodText");
  let food = {
    newFood: foodInput.value,
  };

  axios.post(`http://localhost:3000/food`, food).then((res) => {
    console.log(res.data);
    for (let i = 0; i < res.data.length; i++) {
      let newPara = document.createElement("p");
      newPara.textContent = res.data[i];
...
var result = document.querySelector("#create-form");
result.addEventListener("submit", createFood);
